...
public class Search extends ActivityInstrumentationTestCase2 {
    ...
    public void testSearchBar() throws Exception{
	    ...
	    //focus on search bar
	    assertTrue("Fucus is not on search bar.",solo.getText("搜尋全部分類").isFocused());
    ...
    public void testPictureChaoIsShown() throws Exception{
	    ...
	    assertTrue("Picture is not shown In the upper left corner",Action.getIsViewShown(solo, "id/home",1));
    ...
    public void testBackToPreviousScreen() throws Exception{
	    ...
	    assertFalse("Can not back to the previous screen.",solo.getText("最新動態").isFocused());
    ...
    public void testListUnderSearchBar() throws Exception{
        ...
        {   
    	    ...
    	    assertEquals("Auto-complete suggestions number is more than 10.",count,10);
        }
        else
    ...
    public void testPlusIsShownOnListView() throws Exception{
	    ...
	    assertTrue("Plus is shown on suggest list",Action.getIsViewShown(solo, "search_fill_up"));
    ...
    public void testAddSuggestionIntoSearchBar() throws Exception{
	    ...
	    String tv_value=Action.getValuesInTextview(solo, "id/search_suggestion_text",0);
	    
	    //click "+" in list suggestion window
	    Action.clickPlusInOpenWindow(solo,"search_fill_up",0);
	    
	    //get the value in search bar
	    String barvalue=Action.getValuesInTextview(solo, "search_autocompletetext");
    ...
    public void testChangeSuggestionInSearchBar() throws Exception{
	    ...
	    for (int i=0;i<2;i++){
	    	//value where in front of "+"
	    	solo.sleep(3000);
	        tv_value=Action.getValuesInTextview(solo, "id/search_suggestion_text",0);
	    	Action.clickPlusInOpenWindow(solo,"search_fill_up",0);
	    }
	    //get the value in search bar
	    String barvalue=Action.getValuesInTextview(solo, "search_autocompletetext");
    ...
    public void testSearchClearHidden() throws Exception{
	    ...
	    assertFalse("Search clear icon is not hidden.",Action.getIsViewShown(solo, "id/search_clear"));
    ...
    public void testSearchClearAppear() throws Exception{
	    ...
	    assertTrue("Search clear icon is not shown.",Action.getIsViewShown(solo, "id/search_clear"));
    ...
    public void testDeleteByKeywords()throws Exception{
	    ...
	    solo.sleep(3000);
	    String barvalue2=Action.getValuesInTextview(solo, "search_autocompletetext");
	    
	    //input keyword then list suggestion in openwindow
	    assertEquals("Delete more than one characters every times.",barvalue.length()-1,barvalue2.length());
    ...
    public void testListSuggestionUnderSearchBar() throws Exception{
	    ...
	    //input keyword then list suggestion in openwindow
	    assertTrue("Suggestion list is not shown",Action.getIsViewShown(solo, "id/search_suggestion_text"));
    ...
    public void testKeywordOnTheFristLineByChoose() throws Exception{
	    ...
	    String suggestion_record=Action.getValuesInTextview(solo, "id/search_suggestion_text",0);
	    ...
	    String history_record=Action.getValuesInTextview(solo, "id/search_suggestion_text",0);
	    
	    assertEquals("Keyword is not on the first line",suggestion_record,history_record);
    ...
    public void testKeywordOnTheFristLineByInput() throws Exception{
	    ...
	    String history_record=Action.getValuesInTextview(solo, "id/search_suggestion_text",0);
	    assertEquals("Keyword is not on the first line",searchKeys[0],history_record);
    ...
    public void testRecentRecordsListbyChoose()throws Exception{
	    ...
	    String[] searchKeys={"a","b","c","d","e","f","g","h","i","j","k"};
        Action.addHistoryInfomationInSearchBar(solo, searchKeys);
        ...
        for(int j=0;j<10;j++){
    	    ...
    	    assertEquals("The order of suggestion list is not correct.",suggestion_record,searchKey);
    	    //click back icon
        	Action.clickHomeButtonOnScreen(solo); 	
        	}
    }
    ...
    public void testRecentRecordsListbyInput()throws Exception{
    	...
    	//get the value of suggestion list and verify  whether the suggestion list is correct
    	for(int j=0;j<10;j++){
    	    String suggestion_record=Action.getValuesInTextview(solo, "id/search_suggestion_text",j);
    ...
    public void testChangeValueByClickPlus() throws Exception{
	    ...
	    assertEquals("Auto fill value to search bar failed.",barvalue,tv_value);
   ...
   //1937886:Enter any long keyword search
    ...
    public void testSearchBarShowInCategory() throws Exception{
    	...
    	assertTrue("Search icon is hidden.",solo.getView("id/menu_search",0).isShown());
    ...
    public void testBackToWomenClothingList()throws Exception{
    	...
    	assertEquals("Back to fashion women's clothing List failed",barvale.trim(),"流行女裝");
    ...
    public void testBackToCoatList()throws Exception{
    	...
    	assertEquals("Back to fashion women's clothing List failed",barvale.trim(),"上衣");
